            ...
            <section class="section pt-50">
                <div class="container">
                    <div class="breadcrumbs mb-40">
                        ...
                        <span class="breadcrumbs__link"><?= __('Blog', 'static') ?></span>
                    </div>
                    <div class="blog">
                        <div class="head">
                            <h2 class="title"><?= __('Blog', 'static') ?></h2>
                        </div>
                        <div class="island">
                            <?= __('Microbiome science requires precision.', 'static') ?>
                            <?= __('In collaboration with scientists from all over the world, for 110 years we have been working and creating bio microbiotics for you and your health, for the benefit of future generations.', 'static') ?>
                            <?= __('We use probiotic strains with clinical data obtained in Japan.', 'static') ?>
                        </div>
